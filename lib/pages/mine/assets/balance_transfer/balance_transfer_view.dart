...
class BalanceTransferPage extends StatelessWidget {
  final logic = Get.find<BalanceTransferLogic>();

  BalanceTransferPage({Key? key}) : super(key: key);
