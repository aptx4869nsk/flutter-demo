...
class PointsTransferHistoryPage extends StatelessWidget {
  final logic = Get.find<PointsTransferHistoryLogic>();

  PointsTransferHistoryPage({Key? key}) : super(key: key);
...
Widget _transferTypeToggle({
  ...
  required PointsTransferType type,
}) =>
    SizedBox(
      height: 52.h,
      child: Row(
        ...
        children: [
          Expanded(
            child: InkWell(
              onTap: () => toggle.call(PointsTransferType.cashIn),
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: type == PointsTransferType.cashIn
          ...
          Expanded(
            child: InkWell(
              onTap: () => toggle.call(PointsTransferType.cashOut),
              child: Container(
                padding: EdgeInsets.symmetric(
                  horizontal: 15.w,
                  vertical: 15.h,
                ...
                decoration: BoxDecoration(
                  color: type == PointsTransferType.cashOut
                      ? Styles.defaultBtnBgClr
                      : Styles.c_E2F2D1,
                  borderRadius: BorderRadius.circular(8.r),
                  boxShadow: [
                ...
                Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(
                          type == PointsTransferType.cashIn
                              ? Globe.transferInAcc
