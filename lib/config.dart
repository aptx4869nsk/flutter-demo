...
class Config {
  ...
  // 测试服
  static const _host="api.hb728.com";  // 正式服
  // static const _host = "103.244.3.14"; // 测试服
  static const _port = "3690";
  ...
  // aliyun oss
  static const baseUrl = 'https://huanbao-url.oss-cn-hongkong.aliyuncs.com';

  /// initialize Server
  static void initializeServer() async {
    final response = await dio.get('$baseUrl/baseUrl.json');
  ...
  static String get appApiUrl {
    ...
    return url ?? (_isIP ? 'http://$_host:$_port/api' : "https://$_host/api");
  }
}
